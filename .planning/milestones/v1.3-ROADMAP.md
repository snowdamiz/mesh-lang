...
Plans:
- [ ] 19-01-PLAN.md -- ImplDef pre-registration + MIR lowering with Trait__Method__Type mangled names and self parameter handling
- [ ] 19-02-PLAN.md -- Call-site resolution via TraitRegistry lookup + operator dispatch for user types + mir_type_to_ty helper
- [ ] 19-03-PLAN.md -- Where-clause defense-in-depth assertion + monomorphization depth limit
- [ ] 19-04-PLAN.md -- End-to-end integration tests for all five success criteria + smoke test
...
| Trust typeck for where-clause enforcement | Type checker already comprehensively checks where-clause constraints; MIR lowerer adds warning-only defense-in-depth |
...
| 6 | Where clause constraints not threaded to codegen | 19 | Trust typeck + warning-only assertion in lowerer |
...
|-------|----------------|--------|-----------|
| 18. Trait Infrastructure | 3/3 | Complete | 2026-02-08 |
