...
Note: Backpressure buffering (STREAM-05) is handled here conceptually -- the struct fields (buffer, buffer_len, max_buffer) are defined, but the actual BufferMessage/DrainBuffers handlers and stream_drain_ticker actor are implemented in Plan 03.
  </action>
