...
Plans:
- [x] 38-01-PLAN.md -- ProjectData struct, build_project pipeline, backward-compatible build_module_graph wrapper
- [x] 38-02-PLAN.md -- Multi-file-aware build() function, parse error reporting for all modules, E2E tests
