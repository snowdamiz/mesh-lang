...
Plans:
- [ ] 12-01-PLAN.md -- Parser rewrite: bare params, do/end body, multi-clause, guards, error messages, snapshot tests
- [ ] 12-02-PLAN.md -- Formatter, type checker/MIR multi-clause support, e2e tests
...
| 12. Pipe Operator Closures | v1.1 | 0/2 | Planned | - |
