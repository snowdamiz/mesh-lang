...
mod tests {
    ...
    fn hash_int_deterministic() {
        assert_eq!(snow_hash_int(42), snow_hash_int(42));
        assert_ne!(snow_hash_int(42), snow_hash_int(43));
    }

    #[test]
    fn hash_bool_deterministic() {
        assert_eq!(snow_hash_bool(1), snow_hash_bool(1));
        assert_ne!(snow_hash_bool(0), snow_hash_bool(1));
    }

    #[test]
    fn hash_combine_order_matters() {
        let h1 = snow_hash_int(1);
        let h2 = snow_hash_int(2);
        assert_ne!(snow_hash_combine(h1, h2), snow_hash_combine(h2, h1));
    }
}
